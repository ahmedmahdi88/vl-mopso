...
suptitle(['ttest ']);
p=pwd;
saveas(f1,[p '\figuresMobileSink\SetCoverage(mopso-vlmopso)-mobileSink-allScenarios.png']);
saveas(f2,[p '\figuresMobileSink\SetCoverage(nsga2-vlmopso)-mobileSink-allScenarios.png']);
saveas(f3,[p '\figuresMobileSink\SetCoverage-ttest-mobileSink-allScenarios.png']);