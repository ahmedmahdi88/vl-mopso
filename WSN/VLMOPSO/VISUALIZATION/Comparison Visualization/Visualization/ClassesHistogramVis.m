...
vlCount(vlCount==0)=[];
bar(cssvl,vlCount);title('VL-MOPSO');xlabel('classes');ylabel('number of solutions');
saveas(gcf,['figures/VL-MOPSO-Sensors-classesHistogram-scenario-' num2str(Scenario) '.png'])
% subplot(1,2,2)
