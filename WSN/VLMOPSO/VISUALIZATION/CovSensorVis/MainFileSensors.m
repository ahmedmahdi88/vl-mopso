...
% cd ..
% cf=pwd;
% saveas(f1,[cf '\Comparison Visualization\Visualization\figures\randomSolution_sensors_VLMOPSO.png'])
% saveas(f2,[cf '\Comparison Visualization\Visualization\figures\fullCovSolution-sensors-VLMOPSO.png'])
% saveas(f3,[cf '\Comparison Visualization\Visualization\figures\paretoChangeWithLength-sensors-vlmopso.png'])
