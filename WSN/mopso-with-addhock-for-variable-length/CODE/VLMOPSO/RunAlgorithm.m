function [t,paretoFront,paretoSet ,NC,classes,pop]=RunAlgorithm(s,objfun,popSize,nobj,RepSize,lowerBound_pos,heigherBound_pos,lowerBound_dim,higherBound_dim,nGrid,alpha,numberOfIter,w,pMutate,mutateRatio)
tic
...
if rand<pMutate
tmp(1:pop(i).Dim)=mutationPso(tmp(1:pop(i).Dim),mutateRatio,lowerBound_pos,heigherBound_pos);
end
