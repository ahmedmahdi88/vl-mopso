function [t,paretoFront] = RunAlgorithm(nsga2,ObjectiveFunction,lowerDim,higherDim,scenario)
tic
% Generate initial population
[nsga2,A,a,b,m] = GenerateInitialPopulation(nsga2,lowerDim,higherDim);

% Evaluate initial population
for i = 1:nsga2.numberOfSolutions
    nsga2.solutionsObjectiveValues(i,:) = ObjectiveFunction(nsga2.solutions(i,:).pos,A,a,b,m);
end
...
for iter = 1:nsga2.numberOfIterations
    ...
    disp(['scenario: ' num2str(scenario) ' from 10 scenarios | ' 'Iteration: ' num2str(nsga2.currentIteration)]);
    ...
    for i = 1:nsga2.numberOfSolutions
        newSolsObjectiveValues(i,:) = ObjectiveFunction(newPopulation(i,:).pos,A,a,b,m);
    end
