...
suptitle(['ttest ']);
p=pwd;
saveas(f1,[p '\weirstrassStybtangFigs\SetCoverage(mopso-vlmopso)-ws-allScenarios.png']);
saveas(f2,[p '\weirstrassStybtangFigs\SetCoverage(nsga2-vlmopso)-ws-allScenarios.png']);
saveas(f3,[p '\weirstrassStybtangFigs\SetCoverage-ttest-ws-allScenarios.png']);