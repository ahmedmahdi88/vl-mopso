...
suptitle(['ttest ']);
p=pwd;
saveas(f3,[p '\images\SetCoverage(mopsoMut-vlmopso)-allScenarios.png']);
saveas(f1,[p '\images\SetCoverage(mopso-vlmopso)-allScenarios.png']);
saveas(f2,[p '\images\SetCoverage(nsga2-vlmopso)-allScenarios.png']);
saveas(f4,[p '\images\SetCoverage-ttest-allScenarios.png']);