...
cd 'Results_Math_weierstrass_stybtang'
% cd 'Results_Sensors'
currentFolder = pwd;
...
n=load(['NSGA-II - Math\NSGA-II - Math-maxLength=35\ResultsMath-weierstrass_stybtang\Scenario-' num2str(Scenario) '\Scenario-' num2str(Scenario) '_Benchmarck-NSGA-II.mat']);
...
cd 'mopso-with-addhock-for-variable-length/Results_Math_weierstrass_stybtang'
