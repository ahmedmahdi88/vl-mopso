...
for iter=1:numberOfIter
    ...
    for c=1:NC
        ...
        for i=1:length(tmpAMC)
            ...
            tmp= RVP_CheckConstraints(tmp,sensorPos,covThreshold,DistThreShold,AddedSensorsThreshold,env,lowerBound_pos,heigherBound_pos)
    ...
    for j=1:NC
        ...
        for i=1:length(tmp1)
            if tmp1(i).cont>enhancement_timeout && length(tmp1)>5 % if the particle isn't improved within...
                ...
                newClassTemp.pos=RVP_CheckConstraints( newClassTemp.pos,sensorPos,covThreshold,DistThreShold,AddedSensorsThreshold,env,lowerBound_pos,heigherBound_pos)
