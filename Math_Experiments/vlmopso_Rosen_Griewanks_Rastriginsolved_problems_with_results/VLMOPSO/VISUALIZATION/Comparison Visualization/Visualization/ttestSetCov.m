...
suptitle(['ttest ']);
p=pwd;
saveas(f1,[p '\rosen-grie-rastrigin\SetCoverage(mopso-vlmopso)-rgr-allScenarios.png']);
saveas(f2,[p '\rosen-grie-rastrigin\SetCoverage(nsga2-vlmopso)-rgr-allScenarios.png']);
saveas(f3,[p '\rosen-grie-rastrigin\SetCoverage-ttest-rgr-allScenarios.png']);