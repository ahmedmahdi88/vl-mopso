...
cd 'Results_Math_Rosen_Griewanks_Rastrigin'
% cd 'Results_Sensors'
currentFolder = pwd;
...
n=load(['NSGA-II - Math\NSGA-II - Math-maxLength=35\ResultsMath-Rosen_Griewanks_Rastrigin\Scenario-' num2str(Scenario) '\Scenario-' num2str(Scenario) '_Benchmarck-NSGA-II.mat']);
...
cd 'mopso-with-addhock-for-variable-length/Results_Math_Rosen_Griewanks_Rastrigin'
...
cd ..
cd Results_Math_Rosen_Griewanks_Rastrigin_WithoutMutation
currentFolder = pwd;
