...
n=load(['NSGA-II - Math\NSGA-II - Math-maxLength=35\ResultsMath-rosen_levy\Scenario-' num2str(Scenario) '\Scenario-' num2str(Scenario) '_Benchmarck-NSGA-II.mat']);
...
cd 'mopso-with-addhock-for-variable-length/Results_Math_rosen_levy'
...
cd ..
cd Results_Math_rosen_levy_WithoutMutation
currentFolder = pwd;
