...
suptitle(['ttest ']);
p=pwd;
saveas(f1,[p '\styb-gri-schwefel\SetCoverage(mopso-vlmopso)-sgs-allScenarios.png']);
saveas(f2,[p '\styb-gri-schwefel\SetCoverage(nsga2-vlmopso)-sgs-allScenarios.png']);
saveas(f3,[p '\styb-gri-schwefel\SetCoverage-ttest-sgs-allScenarios.png']);