...
cd 'Results_Math_stybtang_Griewanks_Schwefel'
% cd 'Results_Sensors'
currentFolder = pwd;
...
n=load(['NSGA-II - Math\NSGA-II - Math-maxLength=35\ResultsMath-stybtang_Griewanks_Schwefel\Scenario-' num2str(Scenario) '\Scenario-' num2str(Scenario) '_Benchmarck-NSGA-II.mat']);
...
cd 'mopso-with-addhock-for-variable-length/Results_Math_stybtang_Griewanks_Schwefel'
...
cd ..
cd Results_Math_stybtang_Griewanks_Schwefel_WithoutMutation
currentFolder = pwd;
