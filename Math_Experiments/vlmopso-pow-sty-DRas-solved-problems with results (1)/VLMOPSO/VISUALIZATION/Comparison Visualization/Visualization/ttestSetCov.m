...
suptitle(['ttest ']);
p=pwd;
saveas(f1,[p '\figures-pow-stybtang-drastrigin\SetCoverage(mopso-vlmopso)-lsp-allScenarios.png']);
saveas(f2,[p '\figures-pow-stybtang-drastrigin\SetCoverage(nsga2-vlmopso)-lsp-allScenarios.png']);
saveas(f3,[p '\figures-pow-stybtang-drastrigin\SetCoverage-ttest-lsp-allScenarios.png']);