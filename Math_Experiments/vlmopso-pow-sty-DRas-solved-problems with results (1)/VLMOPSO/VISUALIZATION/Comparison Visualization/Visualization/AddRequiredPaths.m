...
cd 'Results_Math_powell_stybtang_DRastrigin'
% cd 'Results_Sensors'
currentFolder = pwd;
...
n=load(['NSGA-II - Math\NSGA-II - Math-maxLength=35\ResultsMath-powell_stybtang_DRastrigin\Scenario-' num2str(Scenario) '\Scenario-' num2str(Scenario) '_Benchmarck-NSGA-II.mat']);
...
cd 'mopso-with-addhock-for-variable-length/Results_Math_powell_stybtang_DRastrigin'
...
cd ..
cd Results_Math_powell_stybtang_DRastrigin_WithoutMutation
currentFolder = pwd;
