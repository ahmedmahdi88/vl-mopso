...
suptitle(['ttest ']);
p=pwd;
saveas(f1,[p '\rosenRastriginFigs\SetCoverage(mopso-vlmopso)-rr-allScenarios.png']);
saveas(f2,[p '\rosenRastriginFigs\SetCoverage(nsga2-vlmopso)-rr-allScenarios.png']);
saveas(f3,[p '\rosenRastriginFigs\SetCoverage-ttest-rr-allScenarios.png']);