...
n=load(['NSGA-II - Math\NSGA-II - Math-maxLength=20\ResultsMath-Rosen_sphere\Scenario-' num2str(Scenario) '\Scenario-' num2str(Scenario) '_Benchmarck-NSGA-II.mat']);
...
cd 'mopso-with-addhock-for-variable-length/Results_Math_Rosen_sphere'
...
cd ..
cd Results_Math_Rosen_sphere_WithoutMutation
currentFolder = pwd;
