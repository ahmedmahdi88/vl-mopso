...
suptitle(['ttest ']);
p=pwd;
saveas(f1,[p '\rosenSphereFigs\SetCoverage(mopso-vlmopso)-rosenSphere-allScenarios.png']);
saveas(f2,[p '\rosenSphereFigs\SetCoverage(nsga2-vlmopso)-rosenSphere-allScenarios.png']);
saveas(f3,[p '\rosenSphereFigs\SetCoverage-ttest-rosenSphere-allScenarios.png']);