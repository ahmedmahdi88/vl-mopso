...
suptitle(['ttest ']);
p=pwd;
saveas(f1,[p '\rastriginStybtangFigs\SetCoverage(mopso-vlmopso)-rs-allScenarios.png']);
saveas(f2,[p '\rastriginStybtangFigs\SetCoverage(nsga2-vlmopso)-rs-allScenarios.png']);
saveas(f3,[p '\rastriginStybtangFigs\SetCoverage-ttest-rs-allScenarios.png']);