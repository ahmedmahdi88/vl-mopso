...
suptitle(['ttest ']);
p=pwd;
saveas(f1,[p '\MathFigures-levy-sty-pow\SetCoverage(mopso-vlmopso)-lsp-allScenarios.png']);
saveas(f2,[p '\MathFigures-levy-sty-pow\SetCoverage(nsga2-vlmopso)-lsp-allScenarios.png']);
saveas(f3,[p '\MathFigures-levy-sty-pow\SetCoverage-ttest-lsp-allScenarios.png']);